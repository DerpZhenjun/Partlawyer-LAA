...
async def generate_guangdong_evidence(req: EvidenceRequest, background_tasks: BackgroundTasks):
    try:
        template_path = get_template_path("证据清单.docx", "guangdong")
